...
<div class="row">
	<div class="col-md-12">
<form class="form-horizontal" id="save_suplier" action="saveRegister" method="post">
  <div class="form-group">
    <label for="supplierName_add_input" class="col-sm-3 control-label">供应商名称</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" name="supplierName" id="supplierName_add_input" placeholder="供应商名称">
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
	  <input type="text" class="form-control" name="legalPerson" id="legalPerson_add_input" placeholder="法定代表人">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
	  <input type="text" class="form-control" name="financing" id="financing_add_input" placeholder="注册资金（万元）">
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="businessContacter" id="businessContacter_add_input" placeholder="业务联系人">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="telephone" id="telephone_add_input" placeholder="业务联系人电话">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="address" id="address_add_input" placeholder="业务联系人地址">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="openBank" id="openBank_add_input" placeholder="开户行">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="bankCode" id="bankCode_add_input" placeholder="开户行账号">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="businessLicense" id="businessLicense_add_input" placeholder="营业执照编号">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="taxCertificate" id="taxCertificate_add_input" placeholder="税务登记证编号">
    </div>
    <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="certificateTime" id="certificate_time" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})">
    </div>
        <div class="col-sm-1"><span>*</span>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="businessScope" id="businessScope_add_input" placeholder="经营范围">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <textarea rows="3" class="form-control" name="servicePromise" id="servicePromise_add_input"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="applicationOption_add_input" class="col-sm-3 control-label">申请意见</label>
    <div class="col-sm-6">
      <textarea rows="3" class="form-control" name="applicationOption" id="applicationOption_add_input"></textarea>
    </div>
  </div>
   <div class="form-group">
